  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left ">
        <div className="absolute top-0 left-0 w-full -z-10 bg-gradient-to-b from-cyan-100/70 "></div>
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <p>
            Course by <span className="text-blue-600 underline">Abhay</span>
          </p>
        ...
        <div className="max-w-[424px] z-10 shadow-xl rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5">
            ...
            <div className="flex items-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500">
              ...
              <div className="h-4 w-px bg-gray-500/100"></div>

              <div className="flex items-center gap-1">
                <img src={assets.time_clock_icon} alt="click icon" />
              ...
              <div className="flex items-center gap-1">
                <img src={assets.lesson_icon} alt="click icon" />
